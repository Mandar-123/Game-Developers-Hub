				...
				<div class="col-md-3">
					<div class="profile-sidebar">
						...
						<div class="profile-usertitle">
							...
							<div>
								<form class="form-horizontal" action="includes/connect.inc.php" method="post">
											<button type="button"  class="btn btn-primary" name="sub">Connect</button>
								</form>
							</div>
						</div>
				...
				<div class="col-md-9 tab-pane fade in active" id="skills">
					<div class="profile-content">
						<div id="skilldiv">
						   ...
						   <div>
								<div class="col-sm-2">
								<strong><p style="float:right">About Me:</p></strong></div>
								<div class="col-sm-10">
									<div name="des" id="des" class="well well-sm"><?php echo $skillrow['about']?></div>
								</div>
							</div>

							<div>
								<div class="col-sm-2">
								<strong><p style="float:right">Education:</p></strong></div>
								<div class="col-sm-10">
									<div class="well well-sm"><?php echo $skillrow['edu']?></div>
								</div>
							</div>
							<div>
								<div class="col-sm-2">
								<strong><p style="float:right">Experience:</p></strong></div>
								<div class="col-sm-10">
									<div class="well well-sm"><?php echo $skillrow['exp']?></div>
								</div>
							</div>
							...
							<div>
								<div class="col-sm-2">
								<strong><p style="float:right">Skills:</p></strong></div>
									<?php
										$string=$skillrow['otherskills'];
										$skillstring="";
						...
						<div class="container col-md-12" style="margin-top:20px">
							...
							<div class="tab-content">
								...
								<div id="videos" class="tab-pane fade" style="padding:20px">
									...
									<div id="vids">
										<?php
											$sql="SELECT src FROM video WHERE email='$email';";
											$result=mysqli_query($conn,$sql);
